...
検索エージェントの仕事は、情報や知識を必要としているユーザ（クライアント）のために、サーチエンジンや推薦システムを活用して情報を入手することです。検索エージェントと言っても、その形態は多様で、人・ウェブインタフェース・対話型AIシステムなどを含みます。今年度は高度な検索エージェントを実現するために必要と考えられる、以下の研究テーマに取り組む意志のある学生を募集します。
